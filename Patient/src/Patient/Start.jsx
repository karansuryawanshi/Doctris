  ...
  return (
    <div className='bg-slate-900 w-screen h-screen'>
      ...
      <div className='p-4 w-full flex flex-col items-center justify-center mt-28'>
        ...
        <p className='text-xl text-gray-400 mt-6'>Book Appointment instead of waiting in long Queue!!</p>
        <div className='text-gray-400 mt-4 space-y-4 space-x-4'>
          ...
          <label htmlFor="colorRed" className='text-xl'>Patient</label>

          <br/>
          
          <input type="radio" name="favoriteColor" value="Doctor" onChange={handleRoleChange}/>
          <label htmlFor="colorGreen" className='text-xl'>Doctor</label><br/>
        </div>
        <div>
