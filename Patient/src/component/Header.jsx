    ...
    <div className='absolute z-10 w-full h-full'>
        ...
        <div className='flex md:mt-40 md:ml-64 w-96  '>
            <div className=''>
                ...
                <div>
                    <button className='border-2 border-blue-600 bg-blue-600 hover:bg-blue-700 duration-300 p-2 rounded-lg text-white mt-10'onClick={()=>{navigate("/appointment")}}>Make Appointment</button>
                </div>
