                ...
                </div>
                {
                    songData.length > 0 ?
                        <div className='pt-10 space-y-3'>
                            ...
                            <div className='text-black mx-6'>Search Result for <span className='font-bold'>{searchText}</span></div>
                        ...
                        <div className='grid grid-cols-4 text-black'>
                            {fetchData.map((info)=>{
                                return(
                                <div className='w-80 border-2 rounded-lg m-8 hover:bg-gray-200 duration-300 bg-white'>
