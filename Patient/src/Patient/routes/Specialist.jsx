  ...
  const data = [
    {
      ...
      title: "Eye Care",
      description:
        "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Accusamus, quas dolorem. Corrupti architecto consequatur odit.",
    },
    {
      icon: Gynacologist,
      title: "Gynacologist",
  ...
  return (
    <LoggedInHome>
      <div className="flex items-center justify-center">
        <p className="text-4xl font-semibold text-blue-600 px-4 py-3 rounded-xl">
          Specialist
        </p>
      </div>
