...
const CategoryData = [
  {
    ...
    title: "Eye Care",
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis, sapiente tenetur magnam autem vero eaque.",
  },
  {
...
const LoggedinHome = () => {
  ...
  const deleteToken = () => {
    document.cookie =
      "doctortoken=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;";
  };
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      } else console.log("response gained");
    };
    fetchData();
  }, []);
  return (
    <div className="w-screen h-screen">
      <div
        className="w-full h-full hue-rotate-15"
        style={{ backgroundImage: `url(${Poster})` }}
      >
        <div
          className="w-screen h-screen backdrop-brightness-50"
          style={{ backgroundColor: "rgba(140, 192, 229, 0.3)" }}
        >
          <div className="nav h-20 w-full sticky top-0">
            <div
              className={`text-sm font-semibold text-gray-300 duration-300  flex${
            ...
            >
              <ul className="flex space-x-8 p-8  w-8/12">
                ...
                >
                  ...
                  {isDropdownOpen && (
                    ...
                    >
                      <p
                        className="bg-gray-100 text-gray-500 p-1 rounded-t-xl hover:text-black"
                        onClick={() => {
                          navigate("/doctor/offline appointment");
                        }}
                      >
                        Offline Appointment
                      </p>
                      <p
                        className="bg-gray-100 text-gray-500 p-1 rounded-b-xl hover:text-black"
                        onClick={() => {
              ...
              <ul className="w-4/12 flex justify-end space-x-8 mr-32 p-6 \">
                <li className="">
                  <Icon
                    className="text-3xl p-1 rounded-full text-white bg-blue-600 duration-300 cursor-pointer hover:bg-blue-700"
                ...
                >
                  ...
                  {isImageDropdownOpen && (
                    <div
                      className="dropdown-content absolute text-gray-600"
                      onClick={(e) => e.stopPropagation()}
                    >
                      <p
                        className="bg-gray-300 p-1 rounded-t-xl cursor-pointer hover:text-black"
                        onClick={() => navigate(`/doctor/profile/${userId}`)}
                      >
                        Profile
                      </p>
                      <p
                        className="bg-gray-300 p-1 rounded-b-xl cursor-pointer hover:text-black"
                        onClick={deleteToken}
                      >
                        logout
                      </p>
            ...
            <div className="w-7/12 mt-40 space-y-6">
              <div className="flex-col">
                <div className="w-7/12">
                  <img className="w-10 h-10" src={LogoIcon} alt="" />
                </div>
                ...
                <div className="w-7/12 ">
                  <p className="text-gray-300 text-lg ">
                    ...
                    Dicta, unde. Velit nobis quis quam quibusdam fugiat placeat
                    vitae.
                  </p>
                </div>
                <div className="space-y-2">
                  <div>
                    <button className="bg-blue-500 text-white px-2 py-2 rounded-lg">
                      Make Appointment
                    </button>
                  </div>
                  <div>
                ...
                <div className="w-1/3 bg-gray-100 p-4 rounded-l-xl space-y-2">
                  ...
                  <div>
                    <p className="text-gray-600 font-semibold">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Iure impedit dolores molestias!
                    </p>
                  </div>
                  <div className="flex items-center cursor-pointer">
                    ...
                    <span className="pt-2">
                      {" "}
                      <Icon
                        className="text-lg px-2 text-blue-600"
          ...
          <div className="flex items-center justify-center">
            <div className="mt-20 w-9/12 flex">
              <div>
                <img className="w-11/12" src={About} alt="" />
              </div>
              <div className="w-1/2 grid items-center py-40">
                ...
                <div className="text-gray-700">
                  ...
                  ex fugiat saepe porro temporibus, voluptas error quod maiores!
                  Dolorem, praesentium.
                </div>
                <div className="text-gray-700">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                  Laudantium eius reprehenderit id, repudiandae delectus
                  perferendis tenetur, quibusdam nesciunt, amet culpa molestias.
                  Explicabo ad tempore sint excepturi suscipit eius incidunt
                  cumque.
                </div>
                <div>
                  <button className="bg-blue-600 flex text-white px-4 py-2 rounded-lg">
                    {" "}
                    <p> Read More</p>
                    <span className="pt-1">
                      {" "}
                      <Icon
                        className="text-lg px-2 text-white font-semibold"
                        icon={"ph:arrow-right-light"}
                      ></Icon>{" "}
                    </span>{" "}
                  </button>
          ...
          <div className="flex items-center justify-center py-6">
            <div className="w-9/12 space-y-8">
              <div className="flex items-center justify-center">
                <p className="border text-blue-600 px-3 border-blue-500 rounded-xl font-semibold bg-blue-200 text-sm">
                  Departments
                </p>
              </div>
              <div className="flex items-center justify-center ">
              ...
              <div className="flex items-center justify-center">
                <p className="w-7/12 text-lg text-gray-600">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas
                  reiciendis beatae molestiae architecto quos ea. Aliquam
                  necessitatibus natus repudiandae. Incidunt?
                </p>
              </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex">
                        ...
                        <span className="pt-1 text-blue-600">
                          {" "}
                          <Icon icon={"ph:arrow-right-light"}></Icon>
                        </span>
                      </div>
                    </div>
                  );
            ...
            <div className="w-9/12 space-y-8">
              <div className="flex items-center justify-center">
                <div>
                  ...
                  <div className="flex items-center justify-center">
                    <p className="w-7/12 text-lg text-gray-600">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                      Quas reiciendis beatae molestiae architecto quos ea.
                      Aliquam necessitatibus natus repudiandae. Incidunt?
                    </p>
                  </div>
                      ...
                      <div className="p-4">
                        ...
                        <div className="space-y-2 pt-2">
                          <div className="text-sm flex space-x-2">
                            ...
                            ></Icon>{" "}
                            <p className="text-gray-600">63, PG Shustoke, UK</p>
                          </div>
                          <div className="text-sm flex space-x-2">
                            <Icon
                              className="text-blue-500 text-lg "
                          ...
                          <div className="text-sm flex space-x-2">
                            <Icon
                              ...
                              icon={"uil:usd-circle"}
                            ></Icon>{" "}
                            <p className="text-gray-600">$ 75 USD / Visit</p>
                          </div>
                        </div>
                        <div className="flex space-x-3 pt-2">
                          <div className="border rounded-full items-center justify-center px-1 bg-blue-100 cursor-pointer duration-300 hover:bg-blue-600">
                            <Icon
                              className="text-xl p-2 text-blue-600 font-semibold duration-300 hover:text-white"
                  ...
                  <div>
                    <div className="flex items-center justify-center pt-6">
                      <button className="px-4 py-2 bg-blue-600 text-lg text-white rounded-lg duration-300 hover:bg-blue-700">
                        See More
                      </button>
                    </div>
                    <div className="flex items-center justify-center pt-8">
                      ...
                      <div
                        before=" "
                        className="mt-60 absolute content-none bg-blue-500 w-full min-h-96 before:content-[attr(before)]"
                      >
                        <div className="flex items-center justify-center pt-96 space-x-40 py-10 ">
                          <div className="text-white">
                            ...
                            <p className="font-base font-base text-gray-200">
                              From Doctors
                            </p>
                          </div>
                          <div className="text-white">
              ...
              <div className="flex items-center justify-center t-0 ">
                <div className="w-8/12">
                  <div className="pb-10">
                    <div className="flex items-center justify-center">
                      <p className="pb-5 text-4xl font-semibold">
                        Patients Says
                      </p>
                    </div>
                    <div className="flex items-center justify-center">
                      <div className="w-10/12">
                        <p>
                          ...
                          elit. Neque maiores sed, velit eos ipsa magni quas
                          deserunt repellendus doloribus ipsum!
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <Slider {...settings}>
                    <div className="w-100 h-100 bg-gray-100 rounded-lg p-4">
                      <p className="italic">
                        ...
                        well-known dummy text is the Lorem Ipsum, which is said
                        to have originated in the 16th century. "
                      </p>
                      <div className="grid items-center justify-center py-10">
                        <img
                          className="rounded-full w-24 h-24"
                          src="https://images.unsplash.com/photo-1710900791793-487f655010f7?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxMHx8fGVufDB8fHx8fA%3D%3D"
                          alt=""
                        />
                ...
                <div className="flex w-11/12 m-10">
                  <div className="w-1/2 text-white">
                    ...
                    <div className="flex w-96 mb-8 text-lg text-gray-300 ">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Dolorum nobis dolore placeat in sequi itaque quas sit ab
                      est cupiditate!
                    </div>

                    <div className="text-lg mt-8 mb-5  text-gray-300 ">
                      2024© Doctris. Design & Develop with 🙂 by Karan
                      Suryawanshi.
                    </div>
                  </div>
                  <div className="text-gray-300 flex space-x-28 mt-2">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex space-x-4 pt-2">
                        <div className="border border-1 rounded-full cursor-pointer hover:bg-blue-900 duration-300 px-1">
                          <Icon
                            className="w-6 h-6 px-1 py-2"
                            icon={"iconoir:facebook"}
                          ></Icon>
                        </div>
                        <div className="border border-1 rounded-full cursor-pointer hover:bg-blue-900 duration-300 px-1">
