...
const Appointment = () => {
  ...
  const bookAppointment = async () => {
    const makePayment = async () => {
      ...
      const stripe = await loadStripe(
        "pk_test_51PcCIGSBGJbgrrlQ5CMEE2PRtgNa9nSHfNDBKynPxIW4s1vQKyg2m1z8eZsUY8GlyM6tDtSep4weGrs2v3FArpeH0069tSMgZi"
      );
      ...
      const response = await fetch(
        "http://localhost:8000/stripe-checkout-session",
        {
          method: "POST",
          headers: header,
    ...
    if (response) {
      await toast.warn("Appointment booked successfully!", {
        position: "top-right",
        autoClose: 3000,
      ...
      navigate("/patient/offline%20appointment");
    }
  };
  ...
  const [reload, setReload] = useState(0); // State to track reload

  const handleReload = () => {
    setReload(reload + 1); // Change state to trigger re-render
  };
        ...
        <div className="my-5">
          <div className="bg-gradient-to-b from-gray-300 to-gray-0 py-10">
            ...
            <div className="flex items-center justify-center py-2">
              <p className="w-4/12 text-gray-500">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                Corporis itaque ipsam velit mollitia atque ipsa doloremque
                perferendis!
              </p>
            </div>
          </div>
          <div className="w-100 flex items-center justify-center">
            <div className="w-6/12 border-2 rounded-xl overflow-hidden">
              <div className="flex items-center justify-between text-2xl font-semibold text-white rounded-t-xl">
                <p
                  className={`cursor-pointer px-20 py-3 duration-300 text-gray-900 ${
                    isClinicAppointment ? "bg-blue-600 text-white" : ""
                  }`}
                  onClick={ClinicAppointment}
                >
                  Clinic Appointment
                </p>
                <p
                  className={`cursor-pointer px-20 py-3 duration-300 text-gray-900 ${
                    isVirtualAppointment ? "bg-blue-600 text-white" : ""
                  }`}
                  onClick={VirtualAppointment}
                >
                  Virtual appointment
                </p>
              </div>
              {isClinicAppointment && (
                <div className="p-4">
                  <div>
                    <p className="text-normal py-2 font-semibold text-gray-800">
                      Patient Name{" "}
                ...
                <div className="p-4">
                  ...
                  <div className="grid grid-cols-2">
                    ...
                    <div className="">
                      ...
                      >
                        <option value="">Select</option>
                        <option value="10:00 am To 10:15 am">
                          10:00 am To 10:15 am
                        </option>
                        <option value="10:30 am To 11:45 am">
                          10:30 am To 11:45 am
                        </option>
                        <option value="11:00 am To 11:15 am">
                          11:00 am To 11:15 am
                        </option>
                        <option value="11:30 am To 11:45 am">
                          11:30 am To 11:45 am
                        </option>
                        <option value="12:00 pm To 12:15 pm">
                          12:00 pm To 12:15 pm
                        </option>
                        <option value="12:30 pm To 12:45 pm">
                          12:30 pm To 12:45 pm
                        </option>
                        <option value="04:00 pm To 04:15 pm">
                          04:00 pm To 04:15 pm
                        </option>
                        <option value="04:30 pm To 04:45 pm">
                          04:30 pm To 04:45 pm
                        </option>
                        <option value="05:00 pm To 05:15 pm">
                          05:00 pm To 05:15 pm
                        </option>
                        <option value="05:30 pm To 05:45 pm">
                          05:30 pm To 05:45 pm
                        </option>
                        <option value="06:00 pm To 06:15 pm">
                          06:00 pm To 06:15 pm
                        </option>
                        <option value="06:30 pm To 06:45 pm">
