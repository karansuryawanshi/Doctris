                        ...
                        <li 
                            ...
                            {isDropdownOpen && (
                                <div className="dropdown-content absolute" onClick={(e)=>{e.stopPropagation()}}>
                                    <p className="bg-gray-100 p-1 rounded-t-xl hover:text-black" onClick={()=>{navigate("/coming appointment")}}>Online Appointment</p>
                                    <p className="bg-gray-100 p-1 rounded-b-xl hover:text-black" onClick={()=>{navigate("/")}}>Offline Appointment</p>
                                </div>
                            )}
                        </li>
                    ...
                    <ul className='w-4/12 flex justify-end space-x-8 mr-32 p-6 '>
                        ...
                        <li
                            ...
                            <img
                                ...
                                {isImageDropdownOpen && (
                                <div className="dropdown-content absolute" onClick={(e)=>e.stopPropagation()}>
                                    <p className="bg-gray-300 p-1 rounded-t-xl cursor-pointer hover:text-black" onClick={()=>navigate(`/profile/${userID}`)}>Profile</p>
