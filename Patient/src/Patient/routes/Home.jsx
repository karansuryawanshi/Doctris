...
const Home = () => {
  ...
  return (
    <div className='w-screen h-screen'>
        <div className='w-full h-full hue-rotate-15' style={{ backgroundImage: `url(${Poster})`}}>
        <div className='w-screen h-screen backdrop-brightness-50' style={{ backgroundColor: 'rgba(140, 192, 229, 0.3)'}}>
            <div className='nav h-20 w-full sticky top-0'>
                <div className= {`text-sm font-semibold h-24 text-gray-300 duration-300 flex${scrolled ? " bg-gray-200 text-gray-900 sticky top-0" : ""}`}>
                    <ul className='flex space-x-8 p-8  w-8/12'>
                        ...
                        <li className='cursor-pointer'onClick={()=>{navigate("/patient/specialist")}}>SPECIALIST</li>
                    </ul>
                    <ul className='w-4/12 flex justify-end space-x-8 mr-32 p-6 '>
                        ...
                        {profileImage?(
                            <div>
                                <img className='w-10 h-10 rounded-full text-white bg-blue-600 duration-300 cursor-pointer hover:bg-blue-700' src={profileImage} alt="" onClick={profileNavigate}/>
                                <div className='w-16 h-16 space-y-2 bg-white rounded-lg shadow-md left-15 list-none opacity-0 hover:opacity-100 px-0 top-full transition-all  duration-200 ease-in-out'onClick={DashboardNavigate}>
                                    <div className='pl-2 cursor-pointer hover:text-black text-gray-600 font-semibold'><a href={profileNavigate}>Profile</a> </div>
                                    <div className='pl-2 cursor-pointer hover:text-black text-gray-600 font-semibold'onClick={deleteToken}>Logout</div>
                                </div>
                            </div>
                        ):(
                            <img className='w-10 h-10 rounded-full text-white bg-blue-600 duration-300 cursor-pointer hover:bg-blue-700' src={DoctorImage} alt="" onClick={profileNavigate}/>
                        )}
                        </li>
                                    ...
                                    <div className='border'>
                                        ...
                                        <div className='p-4'>
                                            ...
                                            <div className='flex space-x-3 pt-2'>
                                                <div className='px-2 py-2 border rounded-full items-center justify-center bg-blue-100 cursor-pointer duration-300 hover:bg-blue-600'><Icon className='text-xl text-blue-600 font-semibold duration-300 hover:text-white' icon={"iconoir:facebook"}></Icon></div>
                                                <div className='px-2 py-2 border rounded-full items-center justify-center bg-blue-100 cursor-pointer duration-300 hover:bg-blue-600'><Icon className='text-xl text-blue-600 font-semibold duration-300 hover:text-white' icon={"basil:linkedin-outline"}></Icon></div>
                                                <div className='px-2 py-2 border rounded-full items-center justify-center bg-blue-100 cursor-pointer duration-300 hover:bg-blue-600'><Icon className='text-xl text-blue-600 font-semibold duration-300 hover:text-white' icon={"teenyicons:github-outline"}></Icon></div>
                                                <div className='px-2 py-2 border rounded-full items-center justify-center bg-blue-100 cursor-pointer duration-300 hover:bg-blue-600'><Icon className='text-xl text-blue-600 font-semibold duration-300 hover:text-white' icon={"teenyicons:twitter-outline"}></Icon></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='border'>
