...
const Home = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      console.log("Hello This is Home .jsx", response);
      ...
      >
        ...
        >
          <div className="nav h-20 w-full sticky top-0">
            <div
              className={`text-sm font-semibold h-24 text-gray-300 duration-300 flex${
            ...
            >
              ...
              <ul className="w-4/12 flex justify-end space-x-8 mr-32 p-6 ">
                <li className="">
                  <Icon
                    className="text-3xl p-1 rounded-full text-white bg-blue-600 duration-300 cursor-pointer w-10 h-10 hover:bg-blue-700"
                ...
                <li>
                  {profileImage ? (
                    <div>
                      ...
                      />
                      <div
                        className="w-16 h-16 space-y-2 bg-white rounded-lg shadow-md left-15 list-none opacity-0 hover:opacity-100 px-0 top-full transition-all  duration-200 ease-in-out"
                        onClick={DashboardNavigate}
                      >
                        <div className="pl-2 cursor-pointer hover:text-black text-gray-600 font-semibold">
                          <a href={profileNavigate}>Profile</a>{" "}
                        </div>
                        <div
                          className="pl-2 cursor-pointer hover:text-black text-gray-600 font-semibold"
                          onClick={deleteToken}
                        >
                          Logout
                        </div>
                    ...
                    <div className="border">
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex space-x-3 pt-2">
                          <div className="px-2 py-2 border rounded-full items-center justify-center bg-blue-100 cursor-pointer duration-300 hover:bg-blue-600">
                            <Icon
                              className="text-xl text-blue-600 font-semibold duration-300 hover:text-white"
