                        ...
                        <li 
                            ...
                            {isDropdownOpen && (
                                <div className="dropdown-content absolute" onClick={(e)=>{e.stopPropagation()}}>
                                    <p className="bg-gray-100 text-gray-500 p-1 rounded-t-xl hover:text-black" onClick={()=>{navigate("/doctor/offline appointment")}}>Offline Appointment</p>
                                    <p className="bg-gray-100 text-gray-500 p-1 rounded-b-xl hover:text-black" onClick={()=>{navigate("/doctor/online appointment")}}>Online Appointment</p>
                                </div>
                            )}
                        </li>
