...
const ComingAppointment = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            console.log("*****Helo****",response.appointment)
                    ...
                    return(
                        <div className='w-80 border-2 rounded-lg m-8'>
                            ...
                            <div className='px-4 space-y-2 pb-4'>
                                <p className='font-semibold'>Name :- <span className='font-normal text-indigo-900'>{item.patient.firstname} {item.patient.lastname} </span></p>
