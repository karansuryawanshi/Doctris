  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await makeAuthenticatedGETRequest(
        "/appointment/get/all/patient"
      );

      console.log(
        "*****Helo this is coming appointment****",
        response.appointment
      );
      setAppointmentDetail(response.appointment);
      // console.log(response.appointment[0].patient._id);
      setUserId(response.appointment);
      // console.log(userId.patient._id);
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="w-4/12 space-y-4">
          ...
          <p className="text-gray-500">
            ...
            itaque ipsam velit mollitia atque ipsa doloremque perferendis!
          </p>
        </div>
                ...
                return (
                  <div className="w-80 border-2 rounded-lg m-8">
                    <div className="flex items-center justify-center">
                      <img
                        className="w-72 h-72 py-6"
                        src={item.patient.patientPhoto}
                        alt=""
                      />
                    </div>
