  ...
  return (
    <div className="w-8/12 pt-10 rounded-lg" style={{ marginLeft: "25em" }}>
      <div className="flex rounded-xl border-2 duration-300">
        <div
          className={`w-1/2 p-3 rounded-l-xl  flex items-center justify-center cursor-pointer duration-300 ${
            isProfileVisible ? "bg-blue-600 text-white" : " "
          }`}
          onClick={isProfile}
        >
        ...
        <div
          className={`w-1/2 rounded-r-xl p-3 flex items-center justify-center cursor-pointer duration-300 ${
            isProfileSetingVisible ? "bg-blue-600 text-white" : ""
          }`}
          onClick={isProfileSetting}
        >
        ...
        <div className="p-6">
          ...
          <div className="py-6 ">
            <p className="font-normal text-gray-500">
              ...
              Laudantium atque officiis fuga incidunt eaque provident aliquid ut
              officia tempore! Officiis molestias alias earum voluptates ipsa
              nobis accusantium. Maiores, sed et.
            </p>
          </div>
          <div>
            <div>
        ...
        <div className="p-6">
          ...
          <div className="flex">
            <div className="bg-gray-100 w-20 h-20 rounded-full flex items-center justify-center m-4">
              <Icon
                className="text-8xl text-blue-600 p-2"
            ...
            {/* <ProfileImage
              ...
              setDoctorPhoto={setPatientPhoto}
            ></ProfileImage> */}
            <ProfileImage
              setUrl={patientPhoto}
              value={patientPhoto}
              setValue={setPatientPhoto}
              setPatientPhoto={setPatientPhoto} // Pass the setter function, not the value
            ></ProfileImage>
          </div>
          ...
          <div className="flex items-center justify-center py-8">
            <button
              className="border-2 border-blue-600 hover:bg-blue-700 duration-300 px-4 py-2 rounded-xl bg-blue-600 text-white"
              onClick={updateData}
            >
              Save Changes
            </button>
