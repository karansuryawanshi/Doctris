            ...
            <div className='nav h-20 w-full sticky top-0'>
                <div className= {`text-sm font-semibold text-gray-300 duration-300  flex${scrolled ? " bg-gray-200 text-gray-900 sticky top-0" : ""}`}>
                    ...
                    <ul className='w-4/12 flex justify-end space-x-8 mr-32 p-6 \'>
                        ...
                        <li onClick={()=>{navigate("/dashboard")}}><img className='w-10 h-10 rounded-full text-white bg-blue-600 duration-300 cursor-pointer hover:bg-blue-700' src="https://plus.unsplash.com/premium_photo-1712160362268-68616bf1c0d0?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw5fHx8ZW58MHx8fHx8" alt="" /></li>
                    </ul>
                </div>
            </div>
